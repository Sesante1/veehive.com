...
import { verifiedCars } from "@/constants";
import { PencilLine, Trash } from "lucide-react";

const analytics = () => {
    return (
        <div className="flex flex-col gap-y-4">
            <h1 className="title">Verified Cars</h1>
            <div className="card">
                            ...
                            <tbody className="table-body">
                                {verifiedCars.map((product) => (
                                    ...
                                    >
                                        ...
                                        <td className="table-cell">
                                            <div className="flex items-center gap-x-2">{product.verifiedOn}</div>
                                        </td>
                                        <td className="table-cell">
